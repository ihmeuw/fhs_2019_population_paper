...
def tfr_scenarios(da_base, da_99, da_sdg):
    da_99 = da_99.sel(scenario=1).drop("scenario")
    da_99 = expand_dimensions(da_99, scenario=[2])
    da_sdg = da_sdg.sel(scenario=-1).drop("scenario")
    da_sdg = expand_dimensions(da_sdg, scenario=[3])
    
    da_scens = xr.concat([da_base, da_99, da_sdg], dim="scenario").assign_coords(
